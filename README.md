...
- Change playback rate, from a range of 0.1 to 2.0
- Option to disable pitch preservation, where disabling it causes pitch to change depending on playback rate (on by default)
- Option to match duration time to playback rate, for example, if the audio is 20 seconds long, and playback rate is 0.5x it will display 40 seconds
